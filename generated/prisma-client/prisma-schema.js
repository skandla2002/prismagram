...
type Message {
  id: ID!
  text: String!
  from(where: UserWhereInput, orderBy: UserOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [User!]
...
input MessageWhereInput {
  ...
  text_ends_with: String
  text_not_ends_with: String
  from_every: UserWhereInput
  from_some: UserWhereInput
  from_none: UserWhereInput
